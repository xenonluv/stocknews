...
_MOVER_FIELDS = ("code", "name", "sector", "mover_type", "date", "file_date", "provisional", "change_pct", "is_eumbong", "below_prev",
                 "turnover_pct", "turnover_2d_pct", "value_eok", "close_strength", "upper_wick_pct", "lower_wick_pct",
                 "spark_1430_count", "spark_max_body_pct", "spark_source", "frgn_net", "orgn_net", "prsn_net",
