import { TrendingDown, TrendingUp, Flame, HelpCircle, ArrowUpRight } from "lucide-react";
 ...
 * 안전 진입(눌림목/저점)=그린, 상승추세=강세 레드, 과다상승=경고 앰버, 분석불가=중립 그레이.
 */
const STATUS_MAP: Record<
  MarketStatus,
  { variant: "safe" | "warning" | "neutral" | "up"; icon: typeof TrendingUp; label: string }
> = {
  눌림목: { variant: "safe", icon: TrendingDown, label: "눌림목" },
  저점: { variant: "safe", icon: TrendingUp, label: "저점" },
  상승추세: { variant: "up", icon: ArrowUpRight, label: "상승추세" },
