...
⚠ RETIRED: /Users/jinjin/stocknews cron은 2026-07-06 중지됨.
현재 운영 저장소는 /Users/jinjin/kiwoomnews 이다. 이 스크립트는 실수 실행을 막기 위해
ALLOW_RETIRED_STOCKNEWS=1 없이는 중단한다.
...
cron: RETIRED 저장소이므로 설치하지 말 것. 현재 운영 cron은 /Users/jinjin/kiwoomnews 기준.
...
ACTIVE_REPO = "/Users/jinjin/kiwoomnews"
...
def main():
    if os.path.abspath(REPO) == "/Users/jinjin/stocknews" and os.environ.get("ALLOW_RETIRED_STOCKNEWS") != "1":
        sys.stderr.write(
            "ERROR: /Users/jinjin/stocknews is retired since 2026-07-06. "
            f"Use active repo: {ACTIVE_REPO}\n"
            "Set ALLOW_RETIRED_STOCKNEWS=1 only for deliberate historical testing.\n"
        )
        sys.exit(2)
    args = sys.argv[1:]
